                ...
                <div class="flex flex-col justify-center p-8 bg-gray-50 md:p-12">
                    <div class="text-center md:text-left">
                        ...
                        <p class="mb-6 text-gray-600">
                            Enter your email and we'll send you an exclusive one-time use coupon code.
                        </p>
                        ...
                        <form wire:submit.prevent="submitEmail" class="space-y-4">
                            <div>
                                <input type="email"
                                       ...
                                       class="px-4 py-3 w-full rounded-lg border border-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                                       required>
                                @error('email')
