                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-700 rounded-lg">
                            ...
                            <div class="text-right">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    {{ $order->isOrderCompleted() ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' :
                                       ($order->isOrderActive() ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200' :
