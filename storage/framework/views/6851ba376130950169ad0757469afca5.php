   ...
   <div class="flex items-center justify-between">
     ...
     <?php if(request()->routeIs('home')): ?>
       ...
       <div class="flex items-center flex-1 space-x-4 justify-end relative z-[1001]">
           <a href="<?php echo e(route('location')); ?>" class="font-xs uppercase hover:text-red-600 transition-colors <?php echo e(request()->routeIs('home') ? 'text-white group-hover:text-gray-900' : 'text-gray-900'); ?>">Location</a>

           <!-- Currency Selector -->
           <?php echo $__env->make('components.currency-selector', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

           <a href="/login" class="font-xs hover:text-red-600 uppercase transition-colors <?php echo e(request()->routeIs('home') ? 'text-white group-hover:text-gray-900' : 'text-gray-900'); ?>">Account</a>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2479838108-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/elragtow/workfit.medsite.dev/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>