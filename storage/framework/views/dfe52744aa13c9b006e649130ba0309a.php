<?php $__env->startSection('content'); ?>
    ...
    <main class="py-12 px-4">
        <div class="container mx-auto">
            <!-- Shipping Policy -->
            <div x-show="activeTab === 'shipping'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <!-- Domestic Shipping -->
                <section class="mb-16 animate-on-scroll">
                    <h2 class="text-3xl font-bold mb-8 text-center">DOMESTIC SHIPPING</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                        <div class="policy-card bg-white p-6 rounded-lg shadow-md">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-bold">Standard Shipping</h3>
                            </div>
                            ...
                            <p class="text-gray-600">Available for all domestic addresses within the continental United States.</p>
                        </div>
                        ...
                        <div class="policy-card bg-white p-6 rounded-lg shadow-md">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-bold">Express Shipping</h3>
                            </div>
                            <ul class="space-y-2 mb-4">
                                <li class="flex items-start">
                                    <i class="fas fa-check text-red-600 mt-1 mr-2"></i>
                            ...
                            <p class="text-gray-600">Available for all domestic addresses. Orders placed before 2 PM EST are processed the same day.</p>
                        </div>
                    </div>

                    <div class="policy-card bg-white p-6 rounded-lg shadow-md max-w-3xl mx-auto">
                        <div class="flex items-center mb-4">
                            <div class="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center text-red-600 mr-4">
                                <i class="fas fa-rocket text-xl"></i>
                            </div>
                            <h3 class="text-xl font-bold">Overnight Shipping</h3>
                        </div>
                        <ul class="space-y-2 mb-4">
                            <li class="flex items-start">
                                <i class="fas fa-check text-red-600 mt-1 mr-2"></i>
                                <span>Delivery within 1 business day</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check text-red-600 mt-1 mr-2"></i>
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-check text-red-600 mt-1 mr-2"></i>
                                <span>Same-day processing for orders before 12 PM EST</span>
                            </li>
                        </ul>
                        <p class="text-gray-600">Available for most domestic addresses. Some remote areas may require additional time.</p>
                    </div>
                </section>

                <!-- International Shipping -->
                <section class="mb-16 animate-on-scroll">
                    <h2 class="text-3xl font-bold mb-8 text-center">INTERNATIONAL SHIPPING</h2>

                    <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div>
                                <h3 class="text-xl font-bold mb-4">Shipping Options</h3>
                                <ul class="space-y-4">
                                    <li>
                                        ...
                                        <p class="text-gray-600 text-sm">Delivery within 10-15 business days</p>
                                    </li>
                                    <li>
                                        <div class="flex justify-between items-center">
                                        ...
                                        <p class="text-gray-600 text-sm">Delivery within 5-7 business days</p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start">
                                        ...
                                        <span>Customs fees and import duties may apply and are the responsibility of the customer</span>
                                    </li>
                                    <li class="flex items-start">
                                        <i class="fas fa-info-circle text-red-600 mt-1 mr-2"></i>
                                    ...
                                    <li class="flex items-start">
                                        <i class="fas fa-info-circle text-red-600 mt-1 mr-2"></i>
                                        <span>We ship to over 50 countries worldwide</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-4">Shipping Destinations</h3>
                            <p class="text-gray-600 mb-4">We currently ship to the following regions:</p>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div>
                                    <h4 class="font-medium mb-2">North America</h4>
                                ...
                                <div>
                                    <h4 class="font-medium mb-2">Europe</h4>
                                    <ul class="text-sm text-gray-600">
                                ...
                                <div>
                                    <h4 class="font-medium mb-2">Asia Pacific</h4>
                                    <ul class="text-sm text-gray-600">
                                        <li>Australia</li>
                                        <li>Japan</li>
                                        <li>Singapore</li>
                                ...
                                <div>
                                    <h4 class="font-medium mb-2">Other Regions</h4>
                                    <ul class="text-sm text-gray-600">
                                        <li>Brazil</li>
                                        <li>UAE</li>
                                        <li>South Africa</li>
                ...
                <!-- Order Processing -->
                <section class="mb-16 animate-on-scroll">
                    <h2 class="text-3xl font-bold mb-8 text-center">ORDER PROCESSING</h2>
                        ...
                        <div class="mb-8">
                            <div class="flex items-start mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">Once your order is placed, you will receive an email confirmation within 24 hours. This email will include your order number and a summary of your purchase.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">Orders are processed within 1-2 business days. During peak seasons or sales events, processing may take up to 3 business days.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">Once your order is processed, it will be shipped based on the shipping method selected at checkout. You will receive a shipping confirmation email with tracking information.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">Your order will be delivered within the timeframe specified for your chosen shipping method. A signature may be required for certain deliveries.</p>
                                </div>
                            </div>
                        </div>

                        <div class="bg-gray-50 p-6 rounded-lg">
                            <h3 class="text-xl font-bold mb-4">Order Cut-off Times</h3>
                ...
                <section class="mb-16 animate-on-scroll">
                    ...
                    <div class="max-w-4xl mx-auto">
                        <div class="bg-white p-8 rounded-lg shadow-md mb-8">
                            <h3 class="text-2xl font-bold mb-4">30-Day Return Policy</h3>
                            <p class="text-gray-700 mb-6">We want you to love your Workfit products. If for any reason you're not completely satisfied, you can return items within 30 days of delivery for a full refund.</p>
                        ...
                        <div class="bg-gray-50 p-6 rounded-lg">
                            <h3 class="text-xl font-bold mb-4">Return Shipping Costs</h3>
                            <table class="policy-table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Defective or incorrect item</td>
                                        <td>Free (we provide prepaid label)</td>
                                    </tr>
                                    <tr>
                                        <td>Change of mind</td>
                                        <td>$5.99 (deducted from refund)</td>
                                    </tr>
                                    <tr>
                                        <td>International returns</td>
                                        <td>$15.99 (deducted from refund)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="bg-white p-8 rounded-lg shadow-md mb-8">
                            ...
                            <div class="bg-red-50 p-6 rounded-lg">
                                ...
                                <ul class="space-y-2">
                                    ...
                                    <li class="flex items-start">
                                        <i class="fas fa-info-circle text-red-600 mt-1 mr-2"></i>
                                        <span>International exchanges are subject to a $15.99 shipping fee</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <section class="py-12 px-4 bg-gray-100 animate-on-scroll">
                <div class="container mx-auto">
                    <div class="max-w-4xl mx-auto text-center">
                        ...
                        <p class="text-xl text-gray-600 mb-8">Our customer service team is here to help</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <div class="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <a href="mailto:support@workfit.com" class="text-red-600 font-medium hover:underline">support@workfit.com</a>
                            </div>
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p class="text-gray-600 mb-4">Monday-Friday, 9 AM - 6 PM EST</p>
                                <a href="tel:+15551234567" class="text-red-600 font-medium hover:underline">(555) 123-4567</a>
                            </div>
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p class="text-gray-600 mb-4">Chat with us in real-time</p>
                                <button class="text-red-600 font-medium hover:underline">Start Chat</button>
                            </div>
                        </div>

                        <div class="bg-white p-8 rounded-lg shadow-md">
                            <h3 class="text-2xl font-bold mb-4">Visit Our Help Center</h3>
                            <p class="text-gray-700 mb-6">For more detailed information about our products, services, and policies, visit our comprehensive Help Center.</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/elragtow/workfit.medsite.dev/resources/views/return.blade.php ENDPATH**/ ?>