    ...
    <!--[if BLOCK]><![endif]--><?php if($products->count() > 0): ?>
        <div class="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('product.show', $product->slug)); ?>" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <!-- Product Image -->
                    <div class="relative group">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-black/50 transition-all duration-300 flex items-center justify-center">
                ...
                <div class="p-6">
                                    ...
                                    >
                                        <div class="flex items-center gap-2">
                                            <!--[if BLOCK]><![endif]--><?php if($variant->color): ?>
                                                ...
                                                ></div>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <span class="text-sm font-medium"><?php echo e($variant->name); ?></span>
                                        </div>
                    ...
                    >
                        <!--[if BLOCK]><![endif]--><?php if($selectedVariant): ?>
                            Add to Cart - <?php echo e($currencySymbol); ?><?php echo e(number_format($this->convertPrice($selectedVariant->price), 2)); ?>
...
<?php /**PATH /Users/shereenelshayp/Herd/workfit/resources/views/livewire/collection-products.blade.php ENDPATH**/ ?>
