    ...
    <!--[if BLOCK]><![endif]--><?php if($wishlistItems->count() > 0): ?>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                <a href="<?php echo e(route('product.show', $wishlistItem->product->slug)); ?>">
                    <img src="<?php echo e($wishlistItem->product->getFirstMediaUrl('main_image', 'medium')); ?>"
                ...
                <div class="p-4">
                    <div class="flex justify-between items-start mb-2">
                        <div>
                            ...
                            <p class="text-gray-600 text-sm"><?php echo e($wishlistItem->product->category->name); ?></p>
                        </div>
                        <button wire:click="removeFromWishlist(<?php echo e($wishlistItem->id); ?>)"
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div>
                            <span class="font-bold text-lg"><?php echo e($currencySymbol); ?><?php echo e(number_format($wishlistItem->product->converted_price ?? $wishlistItem->product->price, 2)); ?></span>
                            <!--[if BLOCK]><![endif]--><?php if($wishlistItem->product->compare_price > 0): ?>
                            <span class="text-sm text-gray-500 line-through ml-2">
                                <?php echo e($currencySymbol); ?><?php echo e(number_format($wishlistItem->product->converted_compare_price ?? $wishlistItem->product->compare_price, 2)); ?>
                        ...
                        <span class="bg-red-100 text-red-800 text-xs font-semibold px-2 py-1 rounded">
                            -<?php echo e($wishlistItem->product->discount_percentage); ?>%
                        </span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>

                    <div class="flex gap-2">
                        <button wire:click="addToCart(<?php echo e($wishlistItem->product->id); ?>, <?php echo e($wishlistItem->product->variants->isNotEmpty() ? 'true' : 'false'); ?>)"
...
<?php /**PATH /home/elragtow/workfit.medsite.dev/resources/views/livewire/wishlist-index.blade.php ENDPATH**/ ?>