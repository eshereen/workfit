                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="relative group">
                        <!--[if BLOCK]><![endif]--><?php if($category->media->count() > 0): ?>
                            <img
                                src="<?php echo e($category->getFirstMediaUrl('main_image','medium')); ?>"
                        ...
                        <div class="absolute inset-0 bg-black/50 group-hover:opacity-20 transition-all duration-300 flex items-center justify-center">
