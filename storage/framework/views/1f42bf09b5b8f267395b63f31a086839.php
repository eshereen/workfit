        ...
        <div class="absolute inset-0 z-10">
            <div class="absolute bottom-8 left-0 text-left text-white pl-8 md:pl-12">
                ...
                <div class="flex flex-col sm:flex-row justify-start gap-4 fade-in">
                    <a href="<?php echo e(route('categories.index', 'women')); ?>" class="bg-white hover:bg-red-600  text-gray-950 hover:text-white font-bold py-3 px-8 transition-colors uppercase">
                        SHOP WOMEN
                    </a>
                    <a href="<?php echo e(route('categories.index', 'men')); ?>" class="bg-white hover:bg-gray-400 text-black font-bold py-3 px-8 transition-colors">
                        SHOP MEN
                    </a>
                </div>
            </div>
