<div>
    <!--[if BLOCK]><![endif]--><?php if($showLoyaltySection): ?>
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
        <div class="flex items-center justify-between mb-3">
            <h3 class="text-lg font-semibold text-blue-900">Loyalty Points</h3>
            <div class="text-sm text-blue-700">
                Available: <span class="font-bold"><?php echo e(number_format($availablePoints)); ?> pts</span>
            </div>
        </div>
        ...
        <div class="space-y-3">
            <div>
                ...
                <input
                    ...
                    min="100"
                    step="100"
                    max="<?php echo e($availablePoints); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <!--[if BLOCK]><![endif]--><?php if($redemptionValue > 0): ?>
                <div class="p-3 bg-green-50 border border-green-200 rounded-lg">
                    <p class="text-sm text-green-700">
                        <strong>Discount Value:</strong> $<?php echo e(number_format($redemptionValue, 2)); ?>
            ...
            <div class="flex space-x-2">
                <!--[if BLOCK]><![endif]--><?php if($pointsToRedeem > 0): ?>
                    <button
...
<?php /**PATH /Users/shereenelshayp/Herd/workfit/resources/views/livewire/checkout-loyalty-points.blade.php ENDPATH**/ ?>