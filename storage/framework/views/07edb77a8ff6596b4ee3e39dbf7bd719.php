...
<div class="container mx-auto px-4 py-8 my-20">
            ...
            <div class="p-4">
                ...
                <div class="mt-3 flex items-center justify-between">
                    ...
                    <button wire:click="openVariantModal(<?php echo e($product->id); ?>)"
                            class="add-to-cart bg-gray-950 text-white p-2 rounded-full hover:bg-red-600 border-2 border-gray-950 transition">
                    ...
                    <?php else: ?>
                        ...
                        <button wire:click="addSimpleProductToCart(<?php echo e($product->id); ?>, 1)"
                                ...
                                class="add-to-cart bg-gray-950 border-2 border-gray-950 text-white p-2 rounded-full hover:bg-red-700 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                        </svg>
                    </button>
    ...
    <?php if(request()->routeIs('products.index') && $products && method_exists($products, 'links')): ?>
    <div class="mt-8">
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
        ...
        <div class="mt-6 flex justify-end space-x-3">
            ...
            <button wire:click="addToCart"
                    ...
                    class="px-4 py-2 text-white rounded transition-colors <?php echo e($selectedVariant && $quantity > 0 && $selectedVariant->stock > 0 && $quantity <= $selectedVariant->stock ? 'bg-gray-950 border-2 border-gray-950 hover:bg-red-700' : 'bg-gray-400 cursor-not-allowed'); ?>"
