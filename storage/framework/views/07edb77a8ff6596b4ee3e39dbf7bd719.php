    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        @mouseleave="hover = false">
            <div class="relative">
                ...
                <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="absolute top-2 right-2 p-2 bg-white rounded-full shadow-md hover:bg-gray-50 transition-colors z-10" title="Login to add to wishlist">
    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
        ...
        <div class="mb-4 p-3 bg-gray-50 rounded-lg">
            <div class="flex items-center justify-between">
                ...
                <span class="font-bold text-lg"><?php echo e($currencySymbol); ?><?php echo e(number_format($selectedVariant->converted_price ?? $selectedVariant->price ?? $selectedProduct->converted_price ?? $selectedProduct->price, 2)); ?></span>
            </div>
        ...
        <div class="mt-6 flex justify-end space-x-3">
            ...
            <button wire:click="addToCart"
                    ...
                    class="px-4 py-2 text-white rounded transition-colors <?php echo e($selectedVariant && $quantity > 0 && $quantity <= $selectedVariant->stock ? 'bg-red-600 hover:bg-red-700' : 'bg-gray-400 cursor-not-allowed'); ?>"
                    <?php echo e(!$selectedVariant || $quantity <= 0 || $quantity > ($selectedVariant ? $selectedVariant->stock : 0) ? 'disabled' : ''); ?>>
...
<?php /**PATH /home/elragtow/workfit.medsite.dev/resources/views/livewire/product-index.blade.php ENDPATH**/ ?>