    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
        ...
        <div class="mt-6 flex justify-end space-x-3">
            ...
            <button wire:click="addToCart"
                    ...
                    class="px-4 py-2 text-white rounded transition-colors <?php echo e($selectedVariant && $quantity > 0 && $selectedVariant->stock > 0 && $quantity <= $selectedVariant->stock ? 'bg-gray-950 border-2 border-red-600 hover:bg-red-700' : 'bg-gray-400 cursor-not-allowed'); ?>"
